...
export const COMPANY_INFO = {
  ...
  line: "@phuketgrocery",
  lineUrl: "https://line.me/R/ti/p/@phuketgrocery",
  facebook: "ภูเก็ตโกรเซอรี่ - Phuket Grocery",
  facebookUrl: "https://www.facebook.com/G.phuketgrocery/?locale=th_TH",
  ...
  yearsInBusinessLabel: String(new Date().getFullYear() - 2019),
