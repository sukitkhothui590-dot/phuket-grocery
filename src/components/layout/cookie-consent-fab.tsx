...
export function CookieConsentFab() {
  ...
  return (
    <button
      ...
      className="fixed bottom-4 left-4 z-40 flex items-center gap-2 rounded-full border border-slate-200 bg-white px-3 py-2 text-xs font-semibold text-slate-700 shadow-[0_8px_24px_rgba(15,23,42,0.12)] transition-all hover:border-primary hover:text-primary print:hidden sm:bottom-5 sm:left-5 sm:px-3.5 sm:py-2.5 sm:text-sm"
    >
